// 艺术就是复制粘贴 https://github.com/PKief/vscode-material-icon-theme/blob/main/src/icons/folderIcons.ts
import {IconPack} from './file-icons-types'
...
export const folderIcons: FolderTheme = {
  ...
  icons: [
    ...
    {
      name: 'folder-docs',
      folderNames: ['doc', 'docs', 'document', 'documents', 'documentation', 'post', 'posts', 'article', 'articles']
    },
    {
      name: 'folder-git',
    ...
    {
      name: 'folder-gulp',
      folderNames: ['gulp', 'gulpfile.js', 'gulpfile.mjs', 'gulpfile.ts', 'gulpfile.babel.js']
    },
    {
      name: 'folder-python',
